    ...
    <div className="flex items-center gap-3">
      {links.map((link, index) => (
        <a
          key={index}
          href={link.href || "#"}
          className="w-10 h-10 rounded-full flex items-center justify-center text-[var(--muted,#6b7280)] hover:text-[var(--accent,#3b82f6)] bg-[var(--border,#e5e7eb)]/30 hover:bg-[var(--accent,#3b82f6)]/10 transition-all duration-200"
          target="_blank"
