...
export function FeaturesColumns({
  ...
  const features = [
    { title: feature_1_title, desc: feature_1_desc, icon: ICON_PATHS[0], num: "01" },
    { title: feature_2_title, desc: feature_2_desc, icon: ICON_PATHS[1], num: "02" },
    { title: feature_3_title, desc: feature_3_desc, icon: ICON_PATHS[2], num: "03" },
    { title: feature_4_title, desc: feature_4_desc, icon: ICON_PATHS[3], num: "04" },
  ];
    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          ...
          <p style={{ fontSize: "1.1rem", color: "#64748b", marginTop: "1rem", maxWidth: "560px", marginLeft: "auto", marginRight: "auto" }}>
            {section_subtitle}
          </p>
        </div>
          ...
          {features.map((f, i) => (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.25rem" }}>
                ...
                <span style={{ fontSize: "2.5rem", fontWeight: 800, color: "#f1f5f9", fontFamily: t.fonts.heading, lineHeight: 1 }}>{f.num}</span>
              </div>
              <h3 style={{ fontSize: "1.15rem", fontWeight: 700, color: "#0f172a", fontFamily: t.fonts.heading, margin: "0 0 0.5rem" }}>
                {f.title}
              </h3>
              <p style={{ fontSize: "0.95rem", lineHeight: 1.65, color: "#64748b", margin: 0 }}>
                {f.desc}
              </p>
            </div>
          ))}
